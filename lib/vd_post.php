...
class vD_Post {
    ...
    /*public static*/ const VD_BEGIN_SIGNATURE = '<!-- VisualDesigner BEGIN -->';

    /*public static*/ const VD_END_SIGNATURE = '<!-- VisualDesigner END -->';

    /*public static*/ const VD_POST_TAG = 'vd-post-id';

    // /*public static*/ const VD_VALID_POST_TYPES = array('post', 'page', 'vd_posts', 'vd_posts_private');
    private static $VD_VALID_POST_TYPES = array('post', 'page', 'vd_posts', 'vd_posts_private');

    // Post Sub-Types //
    /*public static*/ const VD_GENERAL_NAME = "";

    /*public static*/ const VD_WEB_ELE_NAME = "web_element";

    /*public static*/ const VD_WP_TEMPLATE_NAME = "wp_template";

    /*public static*/ const VD_PRIVATE_NAME = "private";

    /*public static*/ const VD_BASE_HTML = "<div vd-type='vd-designer' data-type='visual-designer' vd-post-id='%s' vd-focus='true'></div>";

    /*public static*/ const VD_GENERAL_TEMPLATE = "<!-- VisualDesigner BEGIN -->
...
<!-- VisualDesigner END -->";
    ...
    /*public static*/ const VD_WP_TEMPLATE = "<!-- VisualDesigner BEGIN -->
<div class='vd-release'>
...
<!-- VisualDesigner END -->";
    ...
    /*public static*/ const VD_WP_CONTENT_TEMPLATE = "<!-- VisualDesigner BEGIN -->
<div class='vd-release'>
<div data-type='visual-designer' data-framework='wpmenuFramework' vd-designer-name='UNDEFINED' vd-post-id='UNDEFINED' vd-tmpl='UNDEFINED' designer-type='runningDesigner' vd-type='running-designer'>
<section class='vd-section-widget vd-row-container vd-structural-widget vd-widget ui-sortable' vd-type='section'>
    <div class='vd-section-container vd-container-fluid'>
...
<!-- VisualDesigner END -->";
    ...
    /*public static*/ const VD_WEB_ELE_TEMPLATE = "<!-- VisualDesigner BEGIN -->
<div class='vd-release'>
