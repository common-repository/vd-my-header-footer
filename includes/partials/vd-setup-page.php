...
<style type="text/css">
  ...
  .vd-iframe {
    ...
    top: 0;
    left: 50%;
    transform: scale(0.20) translateX(-50%);
          ...
          <div class="vd-column-widget vd-sm-1 vd-xs-1 vd-5" vd-type="column" desktop-width="7" tablet-width="12" mobile-width="12" id="rvdid-29-1">
            <div class="vd-c-middle vd-wizard-widget vd-setup-wizard" vd-type="wizard" id="rvdid-29-4">
              <div class="vd-row-widget" id="rvdid-29-5">
                <div class="vd-column-widget vd-slide vd-1 vd-sm-1 vd-xs-1 vd-c-center vd-c-middle" vd-type="column" id="vd-step1" desktop-width="12" tablet-width="12" mobile-width="12" vd-validator="step1Validator" vd-next='#vd-step2'>
                ...
                <div class="vd-column-widget vd-slide vd-1 vd-sm-1 vd-xs-1 vd-c-center vd-c-middle" vd-type="column" id="vd-step2" desktop-width="12" tablet-width="12" mobile-width="12" vd-validator="step2Validator" vd-next='#vd-step3'>
                ...
                <div class="vd-column-widget vd-slide vd-1 vd-sm-1 vd-xs-1 vd-c-center vd-c-middle" vd-type="column" id="vd-step3" desktop-width="12" tablet-width="12" mobile-width="12" vd-validator="step3Validator" vd-next='#vd-step4'>
                  <p class="vd-text-widget" vd-type="text" id="rvdid-29-34" vd-text-type="p"><span class="">Choose a header template</span></p>
                  <p class="vd-text-widget" vd-type="text" id="rvdid-29-35" vd-text-type="p" vd-font-units="px"><span class="">Choose a pre-made template. And don't worry you can always edit and customise your templates later.</span></p>
                  <div class="vd-c-middle vd-slider-widget vd-template-slider" vd-type="slider" vd-renderer="sliderWidgetRelease">
                    ...
                    <div class="vd-overlay">
                      <span
                        class="vd-icon-widget fas fa-angle-left vd-abs-left vd-abs-middle vd-slider-ar vd-slider-l-ar"
                        vd-tag-name="Arrow"
                        vd-type="icon"
                      ></span>
                      <!-- <div class="vd-slider-bullets vd-bullet-cnt-widget vd-horz vd-sm-horz vd-xs-horz vd-c-center vd-c-middle vd-abs-bottom vd-abs-center" vd-type="bullet-cnt">
                        <span
                          class="vd-icon-widget fas fa-circle vd-bullet"
                          vd-tag-name="Bullet"
                          vd-type="icon"
                        ></span>
                        <span
                      ...
                      <span
                        class="vd-icon-widget fas fa-angle-right vd-abs-right vd-abs-middle vd-slider-ar vd-slider-r-ar"
                        vd-tag-name="Arrow"
                        vd-type="icon"
                      ></span>
                    </div>
                ...
                <div class="vd-column-widget vd-slide vd-1 vd-sm-1 vd-xs-1 vd-c-center vd-c-middle" vd-type="column" id="vd-step4" desktop-width="12" tablet-width="12" mobile-width="12" vd-validator="step4Validator" vd-next='#vd-step5'>
                  <p class="vd-text-widget" vd-type="text" id="rvdid-29-32" vd-text-type="p"><span class="">Choose a footer template</span></p>
                  <p class="vd-text-widget" vd-type="text" id="rvdid-29-33" vd-text-type="p" vd-font-units="px"><span class="">Choose a pre-made template. And don't worry you can always edit and customise your templates later.</span></p>
                  <div class="vd-c-middle vd-slider-widget vd-template-slider" vd-type="slider" vd-renderer="sliderWidgetRelease">
                    <div class="vd-row-widget" vd-target="" style="border: none;">
                      <div class="vd-slide-widget vd-slide vd-c-center vd-c-middle vd-1 vd-sm-1 vd-xs-1" vd-type="slide" desktop-width="12" tablet-width="12" mobile-width="12">
                ...
                <div class="vd-column-widget vd-slide vd-1 vd-sm-1 vd-xs-1 vd-c-center vd-c-middle" vd-type="column" id="vd-step5" desktop-width="12" tablet-width="12" mobile-width="12" vd-validator="step5Validator" vd-next='#vd-step6'>
                  ...
                  <p style="margin-bottom: 3px;"><span class="">Below on the left is your current website and how it looks now. On the below right is your website with pink highlighted areas. These pink highlighted areas will be removed and replaced with your new header &amp;/or footer.</span></p>
                  <p style="margin-top: 3px;"><span>If you don't want to remove these pink hightlighted areas just left click them to de-select them. If you want to remove more areas of your theme simply hover your mouse over the bottom right website and select the pink highlighted areas.</span></p>
                ...
                <div class="vd-column-widget vd-slide vd-1 vd-sm-1 vd-xs-1 vd-c-center vd-c-middle" vd-type="column" id="vd-step6" desktop-width="12" tablet-width="12" mobile-width="12">
                  ...
                  <p class="vd-text-widget" vd-type="text" id="rvdid-29-47" vd-text-type="p" vd-font-units="px"><span class="">Note: your brand new header and/or footer is visible only to you, visitors cannot see it on your website yet. You need to continue onto the next step and <strong>Save your Design</strong> to publish your new header and/or footer. After you publish it, visitors will be able to see your new header and/or footer.</span></p>
              ...
              <div class="vd-overlay">
                ...
                <div
                  class="vd-text-widget vd-abs-left vd-abs-bottom vd-desktop-hidden vd-tablet-hidden vd-mobile-hidden"
                  vd-tag-name="Step Back"
                  vd-type="text"
                  id="rvdid-29-7"
                  vd-text-type="div"
                >
                ...
                <div
                  class="vd-text-widget vd-abs-right vd-abs-bottom vd-desktop-hidden vd-tablet-hidden vd-mobile-hidden"
                  vd-tag-name="Step Forward"
                  vd-type="text"
                  id="rvdid-29-8"
                  vd-text-type="div"
                  style=""
...
(function ($) {
  ...
  window.step1Validator = function(slide) {
    ...
    // console.log(wizardData.profession, wizardData.teamSize, wizardData.profession && wizardData.teamSize);

    if (!wizardData.profession || !wizardData.teamSize)
      return false;
  ...
  window.step5Validator = function(slide, params) {
    params = params || {};
    if (isProcessing || !window.step1Validator() || !window.step2Validator() || !window.step3Validator() || !window.step4Validator())
      return;
    isProcessing = true;
    ...
    if (!params.skipHideElementCSS) {
      ...
      if (mhfStyle && (mhfStyle+'').length)
        wizardData.hideElementsCSS = mhfConvert(mhfStyle);
    ...
    jQuery.ajax({
      ...
      success: function(response) {
        ...
        if(response.type == "success") {
          if (response.editUrl)
            $('.vd-finish-btn').attr('href', response.editUrl);
  ...
  vdmhfShowInstruct = function(slide) {
    ...
    if (slide.attr('id') == 'vd-step5') {
      setTimeout(function() {
        ...
        // console.log('^^^^^^^^^^^^^^^^^^h1', cwin1.document.documentElement.scrollHeight);
        // console.log('^^^^^^^^^^^^^^^^^^h2', cwin3.document.documentElement.scrollHeight);
        // $('#vd-iframe-ml')[0].style.width = cwin1.document.documentElement.scrollWidth + 'px';
        // $('#vd-iframe-ml')[0].style.height = cwin1.document.documentElement.scrollHeight + 'px';
        // $('#vd-iframe-std')[0].style.width = cwin3.document.documentElement.scrollWidth + 'px';
        // $('#vd-iframe-std')[0].style.height = cwin3.document.documentElement.scrollHeight + 'px';
        // console.log('^^^^^^^^^^^^^^^^^^h1', cwin1.document.body.scrollHeight);
        // console.log('^^^^^^^^^^^^^^^^^^h2', cwin3.document.body.scrollHeight);
        // $('#vd-iframe-ml')[0].style.width = cwin1.document.body.scrollWidth + 'px';
        // $('#vd-iframe-ml')[0].style.height = cwin1.document.body.scrollHeight + 'px';
        // $('#vd-iframe-std')[0].style.width = cwin3.document.body.scrollWidth + 'px';
        // $('#vd-iframe-std')[0].style.height = cwin3.document.body.scrollHeight + 'px';
        $('#vd-iframe-ml')[0].style.width = cwin1.document.body.scrollWidth + 'px';
        ...
        $('#vd-iframe-std').parent().css('height', $('#vd-iframe-std')[0].getBoundingClientRect().height+60 + 'px');
      }, 10)
  ...
  var sendHideDecision = function(decision) {
    ...
    // $('#vd-iframe-ml')[0].style.width = cwin2.document.documentElement.scrollWidth + 'px';
    // $('#vd-iframe-ml')[0].style.height = cwin2.document.documentElement.scrollHeight + 'px';
  };
  ...
  $(document).ready(function () {
    ...
    // $('input[type="radio"]').prop('checked', false);
    // $('#vd-step1')[0].scrollIntoView({ behavior: "smooth", block: "nearest", inline: "center" });
    ...
    $('.vd-setup-wizard .vd-bullet').on('mouseup', function(ev) {
      ...
      if (bulletIndex == 0) {
        ...
        // prevSlide.nextAll('.vd-slide:not(.vd-skip):first')[0].scrollIntoView({ behavior: "smooth", block: "nearest", inline: "center" });
        mhfScrollTo(slide);
        vdmhfShowInstruct(slide);
      }
      else {
    ...
    $('.vd-skip-btn').click(function() {
      ...
      // var next = $('#vd-step5').nextAll('.vd-slide:not(.vd-skip):first');
      // next[0].scrollIntoView({ behavior: "smooth", block: "nearest", inline: "center" });
      // vdmhfShowInstruct(next);
    });
  });
